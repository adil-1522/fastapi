...
class UserInput(BaseModel):
    ...
    height:Annotated[float,Field(...,gt=0,lt=2.5,description='Height of the person in meters')]
    ...
    city:Annotated[str,Field(...,description='City where the person is living')]
